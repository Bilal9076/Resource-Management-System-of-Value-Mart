...
import Purches from '../Components/Purchase';
...
const arrOfObject = useSelector(state => state.Sellitem.Sell)
    ...
    for (let i = 0; i < array.length; i++) {
      ...
      const Purchesitem = useSelector(state=>state.PurchesItems.purches)
